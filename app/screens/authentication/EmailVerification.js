  ...
  return (
    <SafeAreaView className="flex-1 bg-white px-10">
      <View className="flex-row justify-end mt-14">
        <Link to={{ screen: "Home" }} className="text-primary text-2xl font-medium">
          skip→
        </Link>
      </View>
      ...
      <View className="items-center mt-28">
        ...
        <Text className="text-lg text-gray-500 mb-8">code has been sent to +212603311188</Text>
        ...
        {code.map((digit, index) => (
          <TextInput
            ...
            className={`w-16 h-16 mx-2 rounded-lg text-center text-2xl justify-center items-center ${digit ? 'bg-[#37C8C3] text-white' : 'bg-white border border-[#37C8C3]'}`}
            maxLength={1}
        ...
        <Pressable>
          <Text className="text-[#37C8C3] font-semibold text-lg">Resend code</Text>
        </Pressable>
      </View>
      ...
      <Pressable className="bg-[#37C8C3] rounded-lg py-4 items-center mb-8">
